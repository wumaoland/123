...
function shareText(score) {
    ...
    if (score <= 2.5 * __Time) return '速度不够啊';
    if (score <= 5 * __Time) return '你这也不行啊';
    if (score <= 7.5 * __Time) return '彳亍';
    if (score <= 10 * __Time) return '神仙？';
    return '挂？';
}
